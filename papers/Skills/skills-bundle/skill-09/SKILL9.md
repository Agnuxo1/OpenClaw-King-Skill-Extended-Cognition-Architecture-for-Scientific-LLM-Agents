...
name: skill-09-sympy
description: >
  Symbolic algebra: differentiation, integration, series expansion, equation
  solving, matrix algebra, polynomial manipulation using SymPy.
  NEVER do symbolic math by hand — delegate to this skill.
  Triggers: "symbolic", "simplify", "differentiate", "integrate symbolically",
  "solve equation", "Taylor series", "Laplace transform", "symbolic matrix".
token_savings: 4/5
dependencies: sympy
---
