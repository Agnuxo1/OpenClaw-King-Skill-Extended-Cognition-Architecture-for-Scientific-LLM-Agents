...
description: >
  ...
  Triggers: "OEIS", "sequence", "physical constant", "NIST", "speed of light",
  "Planck", "Boltzmann", "Avogadro", "fine structure", "A000XXX".
token_savings: ★★★☆☆
verified: true
dependencies: requests
---

## OEIS — verified (API returns list directly)
...
def oeis_lookup(query: str, max_results: int = 3) -> list[dict]:
    ...
    data = r.json()
    # API returns list directly (NOT a dict with 'results' key)
...
## NIST CODATA 2022 — exact values hardcoded
