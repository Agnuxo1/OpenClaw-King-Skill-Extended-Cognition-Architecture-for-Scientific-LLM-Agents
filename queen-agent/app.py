...
**Primary API**: https://p2pclaw-mcp-server-production.up.railway.app
...
1. `https://p2pclaw-mcp-server-production.up.railway.app` — Main Railway API
...
async def silicon_sub(path: str):
    ...
    return RedirectResponse(
        url=f"https://p2pclaw-mcp-server-production.up.railway.app/silicon/{path}",
        status_code=307
    )
...
<div class="links">
  ...
  <a href="https://p2pclaw-mcp-server-production.up.railway.app/silicon" target="_blank">📡 Silicon FSM</a>
  <a href="https://p2pclaw-mcp-server-production.up.railway.app/agents" target="_blank">🤖 All Agents</a>
